...
class JoinsDriver implements GlobalConst {
  ...
  public JoinsDriver() {
    ...
    //
    // 1) Creating the "sailors" relation and inserting tuples
    //
    ...
    Ssizes[0] = 30; // first attribute is a 30-char string
    ...
    for (int i = 0; i < numsailors; i++) {
      try {
        t.setIntFld(1, sailors.elementAt(i).sid);
        t.setStrFld(2, sailors.elementAt(i).sname);
        t.setIntFld(3, sailors.elementAt(i).rating);
        t.setFloFld(4, (float)(sailors.elementAt(i).age));
      }
      catch (Exception e) {
    ...
    //
    // 2) Creating the "boats" relation and inserting tuples
    //
    AttrType[] Btypes = {
    ...
    for (int i = 0; i < numboats; i++) {
      try {
        t.setIntFld(1, boats.elementAt(i).bid);
        t.setStrFld(2, boats.elementAt(i).bname);
        t.setStrFld(3, boats.elementAt(i).color);
      }
      catch (Exception e) {
    ...
    //
    // 3) Creating the "reserves" relation and inserting tuples
    //
    ...
    for (int i = 0; i < numreserves; i++) {
      try {
        t.setIntFld(1, reserves.elementAt(i).sid);
        t.setIntFld(2, reserves.elementAt(i).bid);
        t.setStrFld(3, reserves.elementAt(i).date);
      }
      catch (Exception e) {
        System.err.println("*** error in Tuple.setStrFld() ***");
        status = FAIL;
  ...
  public void Query1() {
    ...
    try {
      sm = new SortMerge(
        Stypes, 4, Ssizes,
        Rtypes, 3, Rsizes,
        1, 4,  // join columns for S
        1, 4,  // join columns for R
        10,
        am, am2,
    ...
    if (status != OK) {
      System.err.println("*** Error in get_next tuple ");
      Runtime.getRuntime().exit(1);
    }
    ...
    // Print the counters after finishing Query1
    System.out.println("Query1 - Read I/Os  : " + PCounter.rcounter);
    System.out.println("Query1 - Write I/Os : " + PCounter.wcounter);
  }
  ...
  // -----------------------------------------------------------------------
  public void Query2() {
    PCounter.initialize(); // Reset counters at start
    ...
    FldSpec[] Sprojection = {
      new FldSpec(new RelSpec(RelSpec.outer), 1),
      new FldSpec(new RelSpec(RelSpec.outer), 2),
      // You could include rating/age if needed
    };

    // Create a B+ Tree index on S.sid
    Tuple tt = new Tuple();
    try {
    ...
    // Perform an IndexScan on that BTree
    iterator.Iterator am = null;
    try {
      am = new IndexScan(
        b_index, "sailors.in", "BTreeIndex", Stypes, Ssizes,
        4, 2, Sprojection, null, 1, false
      );
    }
    catch (Exception e) {
    ...
    try {
      sort_names = new Sort(
        JJtype, (short)1, JJsize, (iterator.Iterator)nlj2,
        1, ascending, JJsize[0], 10
      );
    }
    catch (Exception e) {
      System.err.println("*** Error preparing for nested_loop_join");
    ...
    // Print counters:
    System.out.println("Query2 - Read I/Os  : " + PCounter.rcounter);
    System.out.println("Query2 - Write I/Os : " + PCounter.wcounter);
  }
  ...
  public void Query3() {
    ...
    // Print counters
    System.out.println("Query3 - Read I/Os  : " + PCounter.rcounter);
    System.out.println("Query3 - Write I/Os : " + PCounter.wcounter);
  }
  ...
  public void Query4() {
    ...
    // Print counters
    System.out.println("Query4 - Read I/Os  : " + PCounter.rcounter);
    System.out.println("Query4 - Write I/Os : " + PCounter.wcounter);
  }
  ...
  public void Query5() {
    ...
    CondExpr[] outFilter = Query5_CondExpr();
    Tuple t = new Tuple();
    ...
    // Print counters
    System.out.println("Query5 - Read I/Os  : " + PCounter.rcounter);
    System.out.println("Query5 - Write I/Os : " + PCounter.wcounter);
  }
  ...
  public void Query6() {
    ...
    try {
      ...
      System.err.println("*** Error in get_next()");
      System.err.println("" + e);
      Runtime.getRuntime().exit(1);
    }
    ...
    System.out.println("Query6 - Read I/Os  : " + PCounter.rcounter);
    System.out.println("Query6 - Write I/Os : " + PCounter.wcounter);
  }
...
public class JoinTest {
  public static void main(String[] argv) {
    ...
    if (!sortstatus) {
      System.out.println("Error occurred during join tests");
    } else {
